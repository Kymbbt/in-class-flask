...
# instantiating out FLASK app
app = Flask (__name__) #passing in the __name__ variable which just takes thr name of the folder we are in
...
# we are going to us a decorator to create our first route 
...
app.json_encoder = JSONEncoder  #we are not instantiating an object we are simply pointing to this class we made when we need to 
