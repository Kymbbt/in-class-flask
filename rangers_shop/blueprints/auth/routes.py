...
def signup():
    ...
    #we need to instantiate our form as an obkect in order to use it
    ...
    if request.method == 'POST' and registerform.validate_on_submit():
        ...
        db.session.add(user) #thinl of this like "git add ."
...
def signin():
    ...
    if request.method == 'POST' and loginform.validate_on_submit():
        ...
        if user and check_password_hash(user.password, password): 
            ...
            flash(f"Succesfully logged in {email}, category='success'")
